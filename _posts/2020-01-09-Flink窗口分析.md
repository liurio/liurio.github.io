...
![session 2](https://gitee.com/liurio/image_save/blob/master/flink/session%202.jpg)

这时候flink的MergingWindowSet就会把两个元素的时间戳间隔小于session gap的就会在同一个session window中，则：

![Session 3](https://gitee.com/liurio/image_save/blob/master/flink/session%203.jpg)

一个session的例子：

![session 4](https://gitee.com/liurio/image_save/blob/master/flink/session%204.jpg)
...
![session 5](https://gitee.com/liurio/image_save/blob/master/flink/session%205.jpg)
